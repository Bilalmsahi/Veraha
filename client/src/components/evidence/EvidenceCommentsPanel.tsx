...
type EvidenceCommentsPanelProps = {
  evidenceId: string;
};

export function EvidenceCommentsPanel({ evidenceId }: EvidenceCommentsPanelProps) {
  const [content, setContent] = useState('');
  const { data, isLoading } = useEvidenceComments(evidenceId);
  const createComment = useCreateEvidenceComment(evidenceId);
